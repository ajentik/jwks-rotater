...
IMG ?= ghcr.io/ajentik/jwks-rotater:latest
...
KIND_CLUSTER ?= jwks-rotater-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name jwks-rotater-builder
	$(CONTAINER_TOOL) buildx use jwks-rotater-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm jwks-rotater-builder
	rm Dockerfile.cross
...
HELM_NAMESPACE ?= jwks-rotater-system
## Name of the Helm release
HELM_RELEASE ?= jwks-rotater
