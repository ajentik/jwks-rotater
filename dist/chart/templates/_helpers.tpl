...
*/}}
{{- define "jwks-rotater.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "jwks-rotater.resourceName" -}}
{{- $fullname := include "jwks-rotater.fullname" .context }}
{{- $suffix := .suffix }}
